...
use app\models\search\UserSkill as UserSkillSearch;
 ...
 */
class UserSkillController extends TController
{
    ...
    public function actionAdd(/* $id*/)
    {
        ...
        $model->state_id = UserSkill::STATE_ACTIVE;
    ...
    /**
     * Truncate an existing UserSkill model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'UserSkill Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }
