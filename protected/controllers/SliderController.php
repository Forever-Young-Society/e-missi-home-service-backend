...
use app\models\search\Slider as SliderSearch;
 ...
 */
class SliderController extends TController
{
    ...
    public function actionAdd(/* $id*/)
    {
        ...
        $model->state_id = Slider::STATE_ACTIVE;
    ...
    /**
     * Clone an existing Slider model.
     * If update is successful, the browser will be redirected to the 'view' page.
     *
     * @param integer $id
     * @return mixed
    ...
    /**
     * Truncate an existing Slider model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Slider Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }
