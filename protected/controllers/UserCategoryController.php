...
use app\models\search\UserCategory as UserCategorySearch;
 ...
 */
class UserCategoryController extends TController
{
    ...
    public function actionAdd(/* $id*/)
    {
        ...
        $model->state_id = UserCategory::STATE_ACTIVE;
    ...
    /**
     * Clone an existing UserCategory model.
     * If update is successful, the browser will be redirected to the 'view' page.
     *
     * @param integer $id
     * @return mixed
    ...
    /**
     * Truncate an existing UserCategory model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'UserCategory Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }
