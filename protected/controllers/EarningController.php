...
use app\models\search\Earning as EarningSearch;
 ...
 */
class EarningController extends TController
{
    ...
    /**
     * Truncate an existing Earning model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Earning Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }
