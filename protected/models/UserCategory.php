...
/**
 * This is the model class for table "tbl_user_category".
 *
 * @property integer $id
 ...
 */
class UserCategory extends \app\components\TActiveRecord
{
    ...
    public static function getMyCategoryIds()
    {
        return UserCategory::find()->select('category_id')
            ->my()
            ->column();
    }
    ...
    public function asJson()
    {
        $json = [];
        $json['id'] = $this->id;
        $json['title'] = ! empty($this->categoryDetail) ? $this->categoryDetail->title : '';
