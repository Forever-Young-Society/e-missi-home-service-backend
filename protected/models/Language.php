 ...
 */
class Language extends \app\components\TActiveRecord
{
    ...
    {
        $arrayList = ArrayHelper::Map(Language::find()->all(), 'id', 'code');
        $languageHelper = LanguageHelper::getLanguageCode();
        if (! empty($arrayList)) {
