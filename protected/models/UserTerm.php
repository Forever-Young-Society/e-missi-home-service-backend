...
/**
 * This is the model class for table "tbl_user_term".
 *
 * @property integer $id
 ...
 */
class UserTerm extends \app\components\TActiveRecord
{
    ...
    {
        $list = self::getTermOptions();
        return isset($list[$this->term_id]) ? $list[$this->term_id] : 'Not Defined';
    }
    ...
    public static function addData($data)
    {
        ...
        foreach ($data as $item) {
            ...
            $model->term_id = isset($item['term_id']) ? $item['term_id'] : 1;
