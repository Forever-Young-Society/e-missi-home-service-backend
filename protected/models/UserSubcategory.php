...
/**
 * This is the model class for table "tbl_user_subcategory".
 *
 * @property integer $id
 ...
 */
class UserSubcategory extends \app\components\TActiveRecord
{
    ...
    {
        $list = self::getSubCategoryOptions();
        return isset($list[$this->sub_category_id]) ? $list[$this->sub_category_id] : 'Not Defined';
    }
    ...
    public function asJson()
    {
        $json = [];
        $json['id'] = $this->id;
        $json['title'] = ! empty($this->subCategoryDetail) ? $this->subCategoryDetail->title : '';
    ...
    public static function addData($data)
    {
        ...
        foreach ($data as $item) {
            ...
            $model->sub_category_id = isset($item['sub_category_id']) ? $item['sub_category_id'] : 1;
