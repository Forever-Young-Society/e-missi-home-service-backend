...
use app\modules\service\models\search\Term as TermSearch;
 ...
 */
class TermController extends TController
{
    ...
    public function actionAdd(/* $id*/)
    {
        ...
        $model->state_id = Term::STATE_ACTIVE;
    ...
    /**
     * Truncate an existing Term model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Term Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }
