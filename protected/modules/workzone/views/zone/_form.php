...
?>
                  ...
                  <?php echo $form->field($model, 'primary_zipcode')->textInput(['placeHolder'=>'eg. 521823,52300']) ?>
      ...
      <?= Html::submitButton($model->isNewRecord ? Yii::t('app', 'Save') : Yii::t('app', 'Update'), ['id'=> 'zone-form-submit','class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
   </div>
   <?php TActiveForm::end(); ?>
</div>